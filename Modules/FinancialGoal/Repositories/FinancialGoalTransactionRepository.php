...
class FinancialGoalTransactionRepository implements RepositoryApiInterface
{
    ...
    public function __construct(FinancialGoalRepository $financialGoalRepository, TransactionRepository $transactionRepository, CategoryRepository $categoryRepository, FinancialGoalActivityRepository $activityRepo)
    {
    ...
    public function destroy(Request $request, string $id)
    {
        return DB::transaction(function () use ($id, $request) {
            ...
            if ($financialGoalTransaction->status == 'completed') {
                ...
                $this->activityRepo->destroyByTransactionId($financialGoalTransaction->id);
            }
