...
use Modules\Currency\Http\Requests\CurrencyConvertRequest;
...
class CurrencyController extends ApiController
{
    ...
    {
        try {
            $data = $this->repository->convert($request);

            return $this->ok($data);
        } catch (\Exception $e) {
            Log::error($e);
            return $this->fail('Erro ao tentar converter meodas', $e, $e->getCode());
        }
    }
}
